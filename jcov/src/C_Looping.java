...
public class C_Looping {
	...
	public void outputFaktorlBilangan_24(int nilai){
        ...
        for (i=nilai; i>=1; i--) {
            if (nilai % i == 0) {
                System.out.print(i /* tampilkan bilangan ketika nilainya
	...
	public void OutputDeretGanjilGenap_27(int N){
		...
		for (i=0; i<nGanjil; i++){
			System.out.print(deretGanjil[i] + " ");
		}
		System.out.println("Deret Genap");
		for (i=0; i<nGenap; i++){
			System.out.print(deretGenap[i] + " ");
		}
	}
	public boolean guessNumber_28(int guessBil[], int N, int secret){
		...
		while (i<N || ketemu == true){
			if (guessBil[i] < secret) {
				System.out.println( "Sorry, your guess (" + guessBil[i] +") is too low." );
				System.out.println( " Try again.\n> " );
			}else if ( guessBil[i] > secret ) {
				System.out.println( "Sorry, your guess (" + guessBil[i] +") is too high." );
				 System.out.println( " Try again.\n> " );
			}else {
				System.out.println( "Yeaa, your guess (" + guessBil[i] +") is right." );
	...
	public void OutputCountBilPencacah_30(int[] bil, int N, int cari) {
		...
		System.out.println("pencacah 1 = " + count1);
		System.out.println("pencacah 2 = " + count2);
		System.out.println("pencacah 3 = " + count3);
		System.out.println("pencacah 4 = " + count4);
		System.out.println("pencacah 5 = " + count5);
		System.out.println("pencacah 6 = " + count6);
		System.out.println("pencacah 7 = " + count7);
		System.out.println("pencacah 8 = " + count8);
		System.out.println("pencacah 9 = " + count9);
		System.out.println("pencacah 10 = " + count10);
		System.out.println("pencacah diluar 1.d. 10 = " + countUnd);
